...
import 'package:pocket_doc/pages/webView.dart';
...
class _DashboardPageState extends State<DashboardPage> {
  ...
  Future<void> _loadStoredData() async {
    ...
    setState(() {
      name = prefs.getString('name') ?? "Aditya";
      //city = prefs.getString('city') ?? "";
      //hospitalId = prefs.getString('id') ?? "";
      mobilenopref = prefs.getString('mobileno') ?? "696969669";
    });
    print('$mobilenopref');
    print('$name');
    print('$userCity');
  ...
  Future<void> _fetchDashboardData() async {
    ...
    // final url =
    //     Uri.parse('http://localhost:8585/api/dashboard/${mobilenopref}');
      ...
      if (response.statusCode == 200) {
        ...
        setState(() {
          if (kIsWeb) {
            ...
            _profileImage = File.fromRawPath(imageBytes)
                as Uint8List?; // Use File for mobile.
          }
        });
          ...
          child: GestureDetector(
            ...
            child: CircleAvatar(
              backgroundImage: _profileImage != null
                  ? MemoryImage(
                      _profileImage as Uint8List) // Display fetched image
        ...
        return GestureDetector(
          onTap: () {
            Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => HospitalDashPage(
  ...
  Widget _buildHospitalCard(
      String name, String address, String imgPath, String rating) {
    return Container(
